        ...
        <v-list-item>
          <v-list-item-content>
            <v-list-item-action>
              ...
              >
                ...
                <v-card>
                  ...
                  <v-divider />
                  <v-card-actions>
                    <v-btn @click="closeModal" color="primary" name="close" outlined text>
                      close
                    </v-btn>
                    <v-spacer />
                    <v-btn @click="deleteUser()" color="primary" name="accept" outlined text>
                      ok
                    </v-btn>
                  </v-card-actions>
                </v-card>
            ...
            <v-list-item class="deleteInfo">
              *Your data will be deleted, although all messages will be displayed (without the user
              data)
            </v-list-item>
          </v-list-item-content>
        </v-list-item>
